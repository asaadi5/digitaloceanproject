            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> تعديل معلومات المشترك </li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <form action="{{ route('admin_subscriber_update',$subscriber->id) }}" method="post">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="status" class="form-select">
                                                <option value="1" {{ $subscriber->status == 1 ? 'selected' : '' }}>نشط</option>
                                                <option value="0" {{ $subscriber->status == 0 ? 'selected' : '' }}>غير نشط</option>
                                            </select>
                                        </div>
