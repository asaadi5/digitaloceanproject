...
<div class="main-content">
    <section class="section">
        <div class="section-header d-flex justify-content-between">
            <h1>الوكلاء</h1>
            <div class="ml-auto">
                <a href="{{ route('admin_agent_create') }}" class="btn btn-primary">إضافة وكيل<i class="fas fa-plus"></i></a>
            </div>
        </div>
                                ...
                                <table class="table table-bordered" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin_agent_edit',$agent->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('admin_agent_delete',$agent->id) }}" class="btn btn-danger btn-sm delete-btn"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
