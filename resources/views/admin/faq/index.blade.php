        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header d-flex justify-content-between">
                    ...
                    <div class="ml-auto">
                        <a href="{{ route('admin_faq_create') }}" class="btn btn-primary">إضافة سؤال<i class="fas fa-plus"></i></a>
                    </div>
                </div>
                                            ...
                                            @foreach ($faqs as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin_faq_delete',$item->id) }}" class="btn btn-danger btn-sm delete-btn"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
