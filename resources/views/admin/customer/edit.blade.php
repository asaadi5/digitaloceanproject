                        ...
                        <div class="card-body">
                            <form action="{{ route('admin_customer_update',$customer->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/'.$customer->photo) }}" alt="لا يوجد" class="table-img">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" class="form-select">
                                        <option value="0" {{ $customer->status == 0 ? 'selected' : '' }}>قيد الانظار</option>
                                        <option value="1" {{ $customer->status == 1 ? 'selected' : '' }}>نشط</option>
                                        <option value="2" {{ $customer->status == 2 ? 'selected' : '' }}>معلق</option>
                                    </select>
                                </div>
